...
assert.match(app, /Track where the party is, who and what is present/);
assert.match(app, /active Scene is carried by the Area card/);
...
assert.match(questTracker, /state\.revealed/);
assert.match(questTracker, /data-add-side-quest/);

console.log('Spatial cards, Area-carried Scene details, role-safe full cards, item uses, and quest tracking are protected.');
