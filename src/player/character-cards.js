import { additionalPregens } from "./pregen-roster-complete.js";
...
const fighter2014 = deepFreeze({
  ...
  originNotes:["2014 Human ability increases are already included in the listed final ability scores.","Soldier supplies Athletics and Intimidation; Fighter supplies Acrobatics and Perception."], equipmentNotes:["2014 Fighter starting equipment supports leather armor + longbow, a martial weapon + shield, and an explorer/dungeoneer pack."], spellcastingAbility:null, spellSlots:{}, spells:[], spellDetails:{cantrips:[],known:[],prepared:[],alwaysPrepared:[],spellbook:[],origin:[],lineage:[]}
});
