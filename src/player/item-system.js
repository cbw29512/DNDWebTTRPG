...
export const itemCards = Object.freeze([
  ...
  srd({ id:"shield", name:"Shield", category:"shield", rarity:"standard", image:"🛡️", validSlots:["offHand"], attunement:false, edition:"2014/2024", front:"A sturdy defensive shield", playerText:"While wielding this shield, you gain +2 AC.", dmText:"Apply +2 AC while equipped in the off-hand. A character cannot benefit from more than one shield at a time.", effects:[{kind:"add",target:"ac",value:2}] }),
  srd({ id:"rapier", name:"Rapier", category:"weapon", rarity:"standard", image:"🗡️", validSlots:["mainHand"], attunement:false, edition:"2014/2024", front:"A narrow finesse blade", playerText:"Melee weapon; 1d8 piercing; finesse.", dmText:"Uses the character’s normal attack and damage modifiers. No magic bonus.", attack:{damageDice:"1d8",damageType:"piercing",range:"5 ft."}, effects:[] }),
  srd({ id:"rapier-plus-1", name:"Rapier +1", category:"weapon", rarity:"uncommon", image:"⚔️", validSlots:["mainHand"], attunement:false, edition:"2014/2024", front:"A silver-edged enchanted rapier", playerText:"You gain +1 to attack and damage rolls made with this magic weapon.", dmText:"Apply +1 attack and +1 damage only while this weapon is the active main-hand weapon.", attack:{damageDice:"1d8",damageType:"piercing",range:"5 ft."}, effects:[{kind:"add",target:"attack",value:1},{kind:"add",target:"damage",value:1}] }),
  srd({ id:"shortbow", name:"Shortbow", category:"weapon", rarity:"standard", image:"🏹", validSlots:["mainHand"], attunement:false, edition:"2014/2024", front:"A compact hunting bow", playerText:"Ranged weapon; 1d6 piercing; range 80/320 feet in 2014 rules.", dmText:"Uses the character’s normal attack and damage modifiers. Requires ammunition and two hands to fire.", attack:{damageDice:"1d6",damageType:"piercing",range:"80/320 ft."}, effects:[] }),
