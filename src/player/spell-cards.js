...
const catalog2014=[
 ...
 record({name:'Hunter’s Mark',level:1,school:'Divination',cast:'1 Bonus Action',range:'90 ft.',duration:'Concentration, up to 1 hour',concentration:true,effect:'Mark one creature you can see.',mechanics:'Weapon hits deal +1d6 damage; Advantage to Perception/Survival to find target.',damage:'+1d6 weapon damage',upcast:'Longer duration with higher slots; see source.',source:'PHB 2014 p.251'}),
 record({name:'Goodberry',level:1,school:'Transmutation',cast:'1 Action',range:'Touch',duration:'Berries last 24 hours',components:'V,S,M',effect:'Create 10 magical berries.',mechanics:'A creature uses an action to eat one: regain 1 HP and gain a day of nourishment.',healing:'1 HP per berry',source:'PHB 2014 p.246'}),
...
const catalog2024=[
 ...
 record({name:'Sanctuary',level:1,school:'Abjuration',cast:'1 Bonus Action',range:'30 ft.',duration:'1 minute',save:'WIS',effect:'Ward one creature against direct attacks and damaging targeted spells.',mechanics:'Attacker saves or retargets/loses action; ward ends if target attacks, casts a spell, or deals damage.',source:'PHB 2024 p.313'}),
 ...
 record({name:'Ensnaring Strike',level:1,school:'Conjuration',cast:'1 Bonus Action',range:'Self',duration:'Concentration, up to 1 minute',components:'V',concentration:true,save:'STR',effect:'Cast immediately after you hit a creature with a weapon.',mechanics:'Failed save: Restrained and 1d6 piercing at start of each turn; action Athletics vs DC to escape.',damage:'1d6 piercing/turn',upcast:'+1d6 per slot above 1st.',source:'PHB 2024 p.268'}),
