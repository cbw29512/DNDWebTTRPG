...
export function applyCombatTransition(state,command){
  ...
  const combatCommands=new Set([
    SESSION_COMMANDS.SET_COMBAT_INITIATIVE,SESSION_COMMANDS.SET_COMBAT_GROUP_INITIATIVE,SESSION_COMMANDS.BEGIN_COMBAT_ROUNDS,SESSION_COMMANDS.ADVANCE_COMBAT_TURN,
